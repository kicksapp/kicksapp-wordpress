...
function twentyfifteen_entry_meta() {
	...
	if ( in_array( get_post_type(), array( 'post', 'attachment' ) ) ) {
		...
		printf( '<span class="posted-on"><span class="screen-reader-text">%1$s </span><span class="glyphicon glyphicon-time"></span> <a href="%2$s" rel="bookmark">%3$s</a></span>',
	...
	if ( 'post' == get_post_type() ) {
		if ( is_singular() || is_multi_author() ) {
			printf( '<span class="byline"><span class="glyphicon glyphicon-user"></span> <span class="author vcard"><span class="screen-reader-text">%1$s </span><a class="url fn n" href="%2$s">%3$s</a></span></span>',
